...
# Extract EFI partition from .bin

# Mount .bin EFI partition

# Create de EFI partition on the VHD

# Copy files

# Extract the root partition from .bon file

# Copy files

# Create de ext4 partition on the VHD

# Move files to ext4 partition
